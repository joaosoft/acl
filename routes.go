...
func (c *Controller) RegisterRoutes(w manager.IWeb) error {
	err := w.AddRoutes(
		manager.NewRoute(string(web.MethodGet), "/api/v1/acl/domains/:domain_key/roles/:role_key/categories", c.GetCategoriesHandler),
		manager.NewRoute(string(web.MethodGet), "/api/v1/acl/domains/:domain_key/roles/:role_key/categories/:category_key/resources", c.GetResourcesHandler),
		manager.NewRoute(string(web.MethodGet), "/api/v1/acl/domains/:domain_key/roles/:role_key/categories/:category_key/resources/types/:resource_type_key", c.GetResourcesByTypeHandler),
